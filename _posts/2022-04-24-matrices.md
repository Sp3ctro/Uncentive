...
If the [[Determinant | determinant]] of the matrix is nonzero then the matrix is Invertible.

### Singular Matrix
A Singular Matrix is a matrix which does not have an [[Invertible Matrix | inverse]].
...
-   Positive Semi-definite: zMzT>=0
-   Positive Definite: zMzT>0
-   Negative Definite: zMzT<0
